...
namespace Vuplex.WebView {
    ...
    public class WebGLWebView : BaseWebView,
        ...
        /// <summary>
        /// Focuses the Unity game view, which enables Unity to detect keyboard input. When a webview
        /// is focused, Unity is unable to detect keyboard input (i.e. its APIs like Input.GetKey() don't work).
        /// To re-enable Unity's ability to detect keyboard input, the application can use this method to programmatically
        /// shift focus from the webview to the Unity game view.
        /// For more details, see <see href="https://support.vuplex.com/articles/webgl-limitations#input-focus">this article</see>.
        /// </summary>
        /// <example>
        /// <code>
        /// #if UNITY_WEBGL &amp;&amp; !UNITY_EDITOR
