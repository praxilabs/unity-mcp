...
namespace XNodeEditor{
    ...
    public class NodeEditor : XNodeEditor.Internal.NodeEditorBase<NodeEditor, NodeEditor.CustomNodeEditorAttribute, XNode.Node>{
        ...
        public virtual void OnBodyGUI(XNode.Node currentNode){
            DrawNodeFields();
        }

        public void DrawNodeFields()
        {
#if ODIN_INSPECTOR
            inNodeEditor = true;
#endif
        ...
        {
            Type type = target.GetType();
            type.TrySetAttributeWidth(width);
        }

        public virtual int GetWidthOriginal()
        {
            Type type = target.GetType();
            int width;
            if (type.TryGetAttributeWidthOriginal(out width)) return width;
            else return 208;
        }

        public virtual void SetWidthOriginal(int width)
        {
            Type type = target.GetType();
            type.TrySetAttributeWidthOriginal(width);
        }
        ...
        public virtual void AddContextMenuItems(GenericMenu menu){
            ...
            menu.AddItem(new GUIContent("Display"), false, NodeEditorWindow.current.DisplaySelectedNodes);
