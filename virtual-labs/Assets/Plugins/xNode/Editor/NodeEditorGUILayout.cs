...
namespace XNodeEditor {
    ...
    public static class NodeEditorGUILayout {
        ...
        /// <summary> Make a field for a serialized property. Automatically displays relevant node port. </summary>
        public static void ModulePropertyField(SerializedProperty property, bool includeChildren = true, params GUILayoutOption[] options)
        {
            ModulePropertyField(property, (GUIContent)null, includeChildren, options);
        }

        /// <summary> Make a field for a serialized property. Automatically displays relevant node port. </summary>
        public static void ModulePropertyField(SerializedProperty property, GUIContent label, bool includeChildren = true, params GUILayoutOption[] options)
        {
            if (property == null) throw new NullReferenceException();
            //XNode.NodePort port = node.GetPort(property.name);
        ...
        /// <summary>
        /// Add property field and resize the labels and input field accordingly
        /// </summary>
        private static void AddPropertyField(SerializedProperty property, GUIContent label, bool includeChildren = true, params GUILayoutOption[] option)
        {
            if (label == null)
            {
            ...
            EditorGUILayout.PropertyField(property, label, includeChildren, option);
        }
        ...
        public static void PropertyField(SerializedProperty property, GUIContent label, XNode.NodePort port, bool includeChildren = true, params GUILayoutOption[] options) {
            ...
            if (port == null) AddPropertyField(property, null, includeChildren, options);            
            else {
                Rect rect = new Rect();
                ...
                Color col = port.node.inputPortColor;
