...
namespace XNodeEditor {
    ...
    public partial class NodeEditorWindow {
        ...
        private readonly HashSet<UnityEngine.Object> selectionCache = new HashSet<UnityEngine.Object>();
        private HashSet<XNode.Node> culledNodes = new HashSet<XNode.Node>();
        ...
        public void DrawConnections() {
            ...
            foreach (XNode.Node node in graph.nodes) {
                ...
                foreach (XNode.NodePort output in node.Outputs) {
                    ...
                    Color portColor = node.outputPortColor;
        ...
        private void DrawNodes() {
            ...
            for (int n = 0; n < graph.nodes.Count; n++) {
                ...
                nodeEditor.OnBodyGUI(graph.nodes[n]);
        ...
        private void DrawTooltip() {
            ...
            if (tooltip.Length > maxCharacters)
                tooltip = tooltip.Substring(0, maxCharacters) + "...";
            ...
            float wrappedHeight = NodeEditorResources.styles.tooltip.CalcHeight(content, maxWidth);
            float tooltipHeight = Mathf.Min(wrappedHeight, maxHeight);

            Vector2 mousePos = Event.current.mousePosition;
            Rect tooltipRect = new Rect(mousePos.x - maxWidth / 2, mousePos.y - tooltipHeight, maxWidth, tooltipHeight);

            GUI.Label(tooltipRect, content, NodeEditorResources.styles.tooltip);
