...
#region Obsolete
        ...
        public Color inputPortColor = new Color32(255, 255, 255, 255);
        public Color outputPortColor = new Color32(255, 255, 255, 255);
        ...
        [HideInInspector] public bool nodeCollapsed = false;
        [HideInInspector] public bool groupCollapsed = false;
        [HideInInspector] public bool isGroup = false;
...
#region Attributes
        ...
        /// <summary> Specify original width for this node type </summary>
        [AttributeUsage(AttributeTargets.Class, AllowMultiple = false)]
        public class NodeWidthOriginalAttribute : Attribute
        {
            public int originalWidth;
            /// <summary> Specify a width for this node type </summary>
            /// <param name="width"> Width </param>
            public NodeWidthOriginalAttribute(int width)
            {
